...
var topicName = 'process-enhance-company';
var subscriptionName = 'node-enhance-company';
...
subscribe(function(err, message) {
    ...
    console.log('Received request to enhance url ' + message.data.url);
    enhanceCompany(message.data)
